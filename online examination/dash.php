...
<title>Graduation Project || ADMIN DASHBOARD </title>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php?q=0" style="background-color: powderblue;font-family: 'DeanBradleyDemoRegular';"><b>ADMIN DASHBOARD</b></a>
    </div>
...
echo  '<div class="panel logged-user"><div class="table-responsive"><table class="table table-striped title1">
...
if($rowcount == 0){
	...
	<td><b><a href="account.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#31b5af"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
}
else
{
...
echo  '<div class="panel title logged-user"><div class="table-responsive">
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;text-decoration:underline;text-decoration-style: dashed;"><b>Enter Quiz Details</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" class="sub" value="Add Quizz" class="btn btn-primary"/>
  </div>
</div>
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;text-decoration:underline;text-decoration-style: dashed;"><b>Enter Question Details</b></span><br /><br />
...
echo '<div class="form-group">
  <label class="col-md-12 control-label" for=""></label>
  <div class="col-md-12"> 
    <input  type="submit" class="sub" value="Create" class="btn btn-primary"/>
  </div>
</div>
